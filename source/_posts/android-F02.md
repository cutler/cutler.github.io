...
是这样的，你设计图的时候，只需要知道屏幕的分辨率就可以，比如咱定的1280*720 。
但是在实际放到手机上的时候，就会有问题。

比如两台手机的分辨率都是1280*720，但是一台手机是3寸的屏幕，另一台手机是5寸的屏幕。
这样一来，3寸屏的手机，每一寸里所显示的像素点就得比5寸的手机要多才行。

如果我要显示一个“张”字，并且用px做为它的单位，那么这个字在5寸屏显示正好，但是到了3寸屏里就变小了。
